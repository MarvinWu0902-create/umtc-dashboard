<template>
    <div class="table-btm">
        ...
        <div>
            ...
            <!-- pagebtn active -->
            <n-button  strong secondary size="tiny" type="info" :class="{pagebtn:true,active:curPage!=eachpage}" v-for="eachpage of PageItem" :key="eachpage"
                @click="clickPage(eachpage)">{{ eachpage }}</n-button>
...
const {curPage ,PageItem, ItemStr} = storeToRefs(useaoitableset);
////curPage 1
const lastPage=()=>{
