...
import trendHC from './trendHC.vue'
// import {HighchartsVue} from 'highcharts-vue';

import pinia from "@/stores/index.js";
// import { UseaoiFetch } from '../../../../stores/aoi/aoidaily/aoiFetch.js';
import { UseaoiFetch } from '@/stores/aoi/aoidaily/aoiFetch.js';///同上
import { UseaoiTableSet } from '@/stores/aoi/aoidaily/aoiTableSet.js';
...
const { filterTable } = storeToRefs(useaoifetch);

const useaoitableset = UseaoiTableSet(pinia);
const { slicefilterAry } = storeToRefs(useaoitableset);
...
const sendData = async () => {
    ...
    try {
        ...
        alert('上傳成功!');
        filterTable.value.find((item) => item.Remark === postData.lot)
            .value = postData.data
        modalClose();
    } catch (error) {
